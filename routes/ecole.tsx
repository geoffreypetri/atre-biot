  ...
  return (
    <>
      <main class="area rounded cs-xl">
        <h2>Notre école</h2>
        <p>Notre Ecole de Taïchi et d'Arts énergétique : <b>Académie de Taïchi et d'Arts Energétiques (ATRE)</b> a été créée en avril 2017 à Biot.</p>
        <p>Le Président actuel est Monsieur Alain Petri.</p>
        <p>Le constat étant fait qu'il n'y a aucune association proposant ce type d'activités sur Biot, l'axe pédagogique choisi est volontairement une pratique de <i>Bien-être et de bonne santé</i>, et non une pratique martiale. Malgré tout, un léger travail à deux est réalisé les vendredis soirs.</p>
        <p>Nous enseignons principalement le <i>Style Yang Classique</i> et des séries de <a href="/taichi">gymnastiques chinoises (Qi Gong)</a>.</p>
